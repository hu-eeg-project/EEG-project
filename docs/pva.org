...
\\
Ons EEG-systeem kan ook een positief effect hebben op de studenten. Zo is er meer apparatuur aanwezig bij het Turing Lab van de Hogeschool Utrecht. Dit kan dan gebruikt worden voor verder onderzoek of om van te leren voor toekomstige studenten. \\
\\
Het directe doel van dit onderzoek is niet om dingen zoals identificatie of leugen detectie te doen. Maar wordt gericht op de kennis voor het Turing Lab en studenten. Het wordt ook alleen gebruikt op mensen die toestemming geven. Hierdoor is de conclusie dat dit onderzoek ethisch verantwoord is.
