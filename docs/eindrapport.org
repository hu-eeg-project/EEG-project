...
** OpenEEG
Voor de OpenEEG bestaat er een deel voor de versterking en een digitaal gedeelte, voor dit onderzoek is in eerste instantie alleen het deel voor de versterking aangeschaft, met daarnaast een earclip en een paar pasieve en actieve elektrodes. Er is alleen voor de versterking gekozen zodat er een eigen microcontroller met ADC kan worden gebruikt.
...
Bij het uitlezen van deze data is gezien dat er veel 50Hz int het signaal te vinden is en dat fronzen of knipperen geen pieken genereert. Hierna hebben is het derde order deel van de besselworth filter aan de output toegevoegd van de amplifier. Dit deel zit normaal op het digitale gedeelte van de OpenEEG. Dit heeft een duidelijk herkenbaar signaal gemaakt met de 50 Hz en stuk minder erin en bij fronsen zijn nu pieken op de oscilloscoop en onze eigen software te zien. Door een grote capacitor te gebruiken wordt de 50 Hz minder te zien doordat de filter frequentie van de lowpass filter omlaag gaat.
