...
* Aanbevelingen
Uit dit onderzoek is naar voren gekomen dat om de p300 te detecteren een beter signaal uit de hersenen moet worden ontvangen. Advies is om in een vervolg onderzoek het huidige gemaakte systeem met de OpenEEG uit te breiden. Het is te adviseren om te testen of het gebruikt van speciale gel tussen de elektrodes en de hoofdhuid beter resultaat zal brengen. Ook kunnen er dry-elektrodes wordne getest waarmee wellicht ook een goed contact met de hoofdhuid kan worden gemaakt zonder dat de special gel nodig is.
