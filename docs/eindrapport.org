...
Deze techniek is nagemaakt en gecombineerd met en stuk zelf geschreven software dat elke keer dat er een figuur wordt laten zien 200 milliseconden tot 800 milliseconden daarna de inkomende EEG-data opslaat om later te worden geanalyseerd.
