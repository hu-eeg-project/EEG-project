...
Om te onderzoeken hoe de P300 kan worden gedetecteerd is er naar andere onderzoeken gekeken.
Een van deze onderzoeken laat BRON! een figuur elke 400 milliseconden kort zien, er is 90% procent kans dat het een blauw vierkant is en 10% kans dat het een rode cirkel is. Deze techniek is nagemaakt en gecombineerd met en stuk zelf geschreven software dat elke keer dat er een figuur wordt laten zien 200 milliseconden tot 800 milliseconden daarna de inkomende EEG-data opslaat om later te worden geanalyseerd.
