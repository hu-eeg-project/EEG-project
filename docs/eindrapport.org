...
:UNNUMBERED: t
:END:
Dit verslag gaat over de interactie van een mens naar een computer door middel van hersenactiviteit. Hierbij worden met één of meerdere elektrodes die op het hoofd geplaatst worden stroom gemeten om zo een computer te kunnen besturen. Bij het onderzoek hebben we drie verschillende systemen getest. Hierbij is een goedkope speelgoed versie getest van star wars die "Force Trainer" heet, een open source variant onder de naam "OpenEEG" =en= een versie die tijdens het onderzoek gebouwd wordt met losse standaard componenten. Uiteindelijk is er uit gekomen dat met de Force Trainer geen significant signaal waarvoor gezocht werd gevonden kon worden, met de OpenEEG is op het einde wel wat gevonden wat het zou kunnen zijn maar daar moet nog een vervolg onderzoek voor gedaan worden en tenslotte was voor de eigen hardware geen voldoende tijd meer om werkend te krijgen.
