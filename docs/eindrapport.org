...
*** TODO Nyquist Sampling Rate uitleggen
**** Elektrode
...
#+ATTR_LATEX: :environment longtable :align |p{2cm}|p{1,5cm}|p{1,5cm}|p{1,5cm}|p{1,5cm}|p{2cm}|p{2cm}|p{2cm}|
|-----------------+-------------+----------+-----------+----------+---------------------+----------------------+---------|
| Naam            | Prijs(Euro) | Precisie | Range (V) | sps      | input noise uV(RMS) | Output noise uV(RMS) | kanalen |
|-----------------+-------------+----------+-----------+----------+---------------------+----------------------+---------|
| MCP3021         | 0,94        | 10-bit   | -0.6~3,4  | 22k      |                     |                      |       1 |
| TLC1543         | 12,95       | 10-bit   | Reference | 32k      |                     |                      |      11 |
| MCP3008         | 3,50        | 10-bit   |           | 75k-200k |                     |                      |       8 |
| ad7705          | 2,60        | 16-bit   |           | ?        |                     |                      |       2 |
| ads1115         | 2,50        | 16-bit   |           | 860      | 32,25               |                      |       2 |
| ESP32 ADC       | 13,99       | 12-bit   | 0-3,9     | ?        | ?                   | ?                    |     2x8 |
| Arduino Uno adc |             | 8-bit    |           |          |                     |                      |         |
|-----------------+-------------+----------+-----------+----------+---------------------+----------------------+---------|
