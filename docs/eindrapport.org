...
** Conclusie
In conclusie is het belangrijkste gedeelte van een EEG-systeem dus de het versterkingsgedeelte. Voor het versterkingsgedeelte is op de eerste stap waar het signaal uit de elektrodes binnenkomt een inamp. Deze inamp zorgt ervoor dat het signaal zijn eerste versterking krijgt naar een punt dat het signaal-ruis verhouding klein genoeg is. Hier wordt niet voor een opamp gekozen maar voor een inamp omdat een inamp minder ruis veroorzaakt. Vanuit de inamp komt ook de DRL (PAUL UITLEGGEN). \\
 Na de inamp kom het filteren van het signaal. Het belangrijkste om er uit te filteren is de 50Hz, dit kan worden gedaan met een opamp  PAUL UITLEGGEN.
